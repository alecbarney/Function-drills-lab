...
const nameGreeting = nameCheck('Alec');
...
function thatsOdd (num1){
  console.log(num1 % 2 === 0 ? 'Thats not odd' : 'That is odd indeed')
}
...
function theElminator (array, name){
...
const upperCasePhrase = upperCase(sampleString)
////////////////// PROBLEM 18 ////////////////////
/*
...
console.log(emailCheck('alec@abd.com'))
////////////////// PROBLEM 19 ////////////////////
/*
...
////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,4,6,8,9]
/*
...
let bathtubScope = ['rubber duck', 'sailorDuck', 'duck']
